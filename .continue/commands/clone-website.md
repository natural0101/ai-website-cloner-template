...
invokable: true
---
<!-- AUTO-GENERATED from .agents/skills/clone-website/SKILL.md — do not edit directly.
     Run `node scripts/sync-skills.mjs` to regenerate. -->

Target URLs are provided in the user request.
...
Before the inspection pass, read [references/inspection-guide.md](../../.agents/skills/clone-website/references/inspection-guide.md) for the reusable visual, component, layout, and technical audit checklist.
