...
metadata:
  source_url: "https://github.com/jakubkrehel/make-interfaces-feel-better/blob/main/skills/make-interfaces-feel-better/SKILL.md"
---
...
For dashboards, editors, AI design workbenches, and other product UI, apply these details only after the workflow, state coverage, and density model are sound. Read:
...
- [ ] Product UI rows, panels, toolbars, and inspector fields have stable dimensions
- [ ] Selected, pending, loading, error, empty, disabled, and focus-visible states are polished
...
Imported from Aura: https://www.aura.build/skills/36e66f5e-b4b4-4838-86cd-a4164ae91d00/details-that-make-interfaces-feel-better
Original source: https://github.com/jakubkrehel/make-interfaces-feel-better/blob/main/skills/make-interfaces-feel-better/SKILL.md
