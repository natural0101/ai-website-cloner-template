...
4. For proof-like assets, assign claim verdict: verified, needs-evidence, rephrase, visual-only or reject.
5. Write exact specs: aspect ratio, size, crop, subject, composition, style constraints.
6. Write prompt or capture instruction.
7. Write planned path, mobile crop, alt text, performance plan, status and QA.
8. Mirror produced or planned assets into `evidence/asset-manifest.md`.
...
- proof/claim verdict when the asset implies proof;
