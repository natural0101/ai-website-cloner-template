...
> For dashboards, admin panels, SaaS apps, AI design studios, canvas editors, data tools, and product workflows, route to `product-design-taste` first.
...
* Dashboards / dense product UI / admin panels (use `product-design-taste`; then choose Fluent, Carbon, Atlassian, Polaris, shadcn/Radix, or another system only when it matches the product and stack).
...
If the brief is one of the above, **say so explicitly**, point to `product-design-taste` or the right specialist tool, and only apply this skill's marketing-page / about-page / landing-page parts to the surfaces where they apply.
