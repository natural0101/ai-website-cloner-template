"""Compact and lift the v6 tail around its fixed hip root."""
...
ASSET = "comforting_cat_v6_tail_compact_lift_attempt9"
WORKBENCH = Path(
...
checkpoint = (
    CHECKPOINT_DIR / "comforting_cat_v6_before_tail_compact_lift_attempt9.blend"
).resolve()
...
anchor = Vector((0.43, 0.24, 0.74))
factors = Vector((0.92, 0.92, 0.82))
...
scene.name = "Comforting_Cat_V6_TailCompactLift_A9"
scene["comforting_cat_v6_stage"] = "TAIL_COMPACT_LIFT"
scene["comforting_cat_v6_attempt"] = 9
scene["comforting_cat_v6_dominant_defect"] = "tail_too_heavy_low_and_grounded"
scene["comforting_cat_v6_do_not_change"] = json.dumps(
    [
        "tail root anchor",
        "head and face",
        "costume and scarf",
...
report = {
    "asset": ASSET,
    "stage": "TAIL_COMPACT_LIFT",
    "attempt": 9,
    "source_blend": str(SOURCE_BLEND),
    "checkpoint": str(checkpoint),
    "dominant_defect": "tail_too_heavy_low_and_grounded",
    "anchor": list(anchor),
...
bpy.ops.wm.save_as_mainfile(filepath=str(FINAL_BLEND))
print("COMFORTING_CAT_V6_TAIL_COMPACT_LIFT_A9=" + json.dumps(report, ensure_ascii=False))
