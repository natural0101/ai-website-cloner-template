...
profiles = {
    "offset-a": ((0.000, -0.020), (-0.006, -0.030), (-0.012, -0.040)),
    "offset-b": ((0.000, -0.035), (-0.012, -0.047), (-0.024, -0.059)),
    "offset-c": ((0.000, -0.050), (-0.016, -0.066), (-0.032, -0.082)),
}
...
outputs = []
for profile_name, offsets in profiles.items():
    for obj, base, (offset_x, offset_y) in zip(fingers, base_locations, offsets):
