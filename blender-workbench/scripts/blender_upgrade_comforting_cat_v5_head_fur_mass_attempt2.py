"""Head silhouette pass: strengthen broad cheek fur masses in the base mesh."""
...
ASSET = "comforting_cat_v5_head_fur_mass_attempt2"
WORKBENCH = Path(
...
checkpoint = (
    CHECKPOINT_DIR / "comforting_cat_v5_before_head_fur_mass_attempt2.blend"
).resolve()
...
for vertex in head.data.vertices:
    ...
    # Stronger but still broad lobes; valleys remain shallow enough to avoid
    # porcupine spikes. Only the outer silhouette is affected.
    lobe = (
    ...
    point.x += math.copysign(lobe * side_ratio**4, point.x)
...
scene.name = "Comforting_Cat_V5_HeadFurMass_A2"
scene["comforting_cat_target_mode"] = "TRUE_360"
scene["comforting_cat_v5_stage"] = "HEAD_FUR_MASS"
scene["comforting_cat_v5_geometry_attempt"] = "head_fur_mass_2"
scene["comforting_cat_v5_dominant_defect"] = "weak_polygonal_cheek_silhouette"
scene["comforting_cat_v5_do_not_change"] = json.dumps(
    [
        "head depth and crown",
        "ears",
        "eyes, integrated lids and brows",
...
report = {
    ...
    "dominant_defect": "weak_polygonal_cheek_silhouette",
    "before": before,
    "after": after,
...
bpy.ops.wm.save_as_mainfile(filepath=str(FINAL_BLEND))
print("COMFORTING_CAT_V5_HEAD_FUR_MASS_A2=" + json.dumps(report, ensure_ascii=False))
