"""Correct the chest inset contact after the material/shape pass."""
...
ASSET = "comforting_cat_v5_chest_inset_attempt2"
WORKBENCH = Path(
...
SOURCE_BLEND = (BLEND_DIR / "comforting_cat_v5_chest_inset_attempt1.blend").resolve()
...
checkpoint = (
    CHECKPOINT_DIR / "comforting_cat_v5_before_chest_inset_attempt2.blend"
).resolve()
...
matrix = inset.matrix_world.copy()
matrix.translation += Vector((0.0, 0.050, 0.0))
inset.matrix_world = matrix
bpy.context.view_layer.update()

scene = bpy.context.scene
scene.name = "Comforting_Cat_V5_ChestInset_A2"
scene["comforting_cat_target_mode"] = "TRUE_360"
scene["comforting_cat_v5_stage"] = "COSTUME_CHEST_INSET_CONTACT"
scene["comforting_cat_v5_geometry_attempt"] = "chest_inset_2"
scene["comforting_cat_v5_dominant_defect"] = "floating_chest_inset"
scene["comforting_cat_v5_do_not_change"] = json.dumps(
    [
        "chest inset shape and material from attempt1",
        "head and expression",
        "scarf and collar",
        "robe silhouette",
        "limbs",
...
report = {
    "asset": ASSET,
    "stage": "COSTUME_CHEST_INSET_CONTACT",
    "attempt": 2,
    "target_mode": "TRUE_360",
    "source_blend": str(SOURCE_BLEND),
    "checkpoint": str(checkpoint),
    "dominant_defect": "floating_chest_inset",
    "rejected_attempt": "comforting_cat_v5_chest_inset_attempt1",
    "world_y_offset": 0.050,
...
bpy.ops.wm.save_as_mainfile(filepath=str(FINAL_BLEND))
print("COMFORTING_CAT_V5_CHEST_INSET_A2=" + json.dumps(report, ensure_ascii=False))
