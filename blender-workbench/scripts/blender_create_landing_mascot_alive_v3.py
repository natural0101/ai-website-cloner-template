...
ASSET = "landing_mascot_alive_v3"
SCENE_NAME = "LandingMascotAliveV3"
END_FRAME = 120
FPS = 24
WIDTH = 1200
HEIGHT = 1000
...
def build_mascot(collection: bpy.types.Collection) -> dict:
    ...
    for obj in (body, belly, collar, leg_l, leg_r, foot_l, foot_r, left_stub, right_socket, upper_r, lower_r, right_shoulder, elbow_r):
    ...
    for obj in (palm_r, finger_r1, finger_r2, finger_r3):
...
def write_scene_graph(parts: dict) -> dict:
    graph = {
        ...
        "expected_contacts": [
            ...
            "right shoulder and forearm stay attached while only the mitten hand waves",
        ...
        "animation": {
            ...
            "frames": END_FRAME,
            "fps": FPS,
            "motions": ["breathing body bob", "antenna drift", "mitten-hand wave", "two blinks"],
