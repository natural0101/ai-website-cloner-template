...
ASSET = "landing_mascot_alive_v4"
SCENE_NAME = "LandingMascotAliveV4"
END_FRAME = 120
FPS = 24
WIDTH = 1200
HEIGHT = 1000
...
def build_mascot(collection: bpy.types.Collection) -> dict:
    ...
    right_arm_pivot = create_empty(collection, "LM_RightHandWavePivot", (0.58, -0.12, 1.64))
    tag(right_arm_pivot, "discarded_hand_wave_pivot", False)
    ...
    animated = [root, body_pivot, head_pivot, left_arm_pivot, antenna_pivot, eye_l, eye_r, glint_l, glint_r]
    ...
    return {
        ...
        "meshes": all_meshes,
        "animated": animated,
        "pivots": [root, body_pivot, head_pivot, antenna_pivot],
    }
...
def animate_character(
    ...
    for frame, rot_y, rot_z in (
        (1, math.radians(-3.0), math.radians(-4.0)),
        (18, math.radians(4.0), math.radians(6.0)),
        (34, math.radians(-4.5), math.radians(-7.0)),
        (50, math.radians(4.5), math.radians(7.0)),
        (66, math.radians(-3.5), math.radians(-5.0)),
        (84, math.radians(1.5), math.radians(2.5)),
        (120, math.radians(-3.0), math.radians(-4.0)),
    ):
        key(right_arm, frame, loc=(0.58, -0.12, 1.64), rot=(0.0, rot_y, rot_z), scale=(1.0, 1.0, 1.0))
...
def write_scene_graph(parts: dict) -> dict:
    graph = {
        ...
        "expected_contacts": [
            ...
            "right shoulder, forearm and mitten stay attached as one readable side gesture",
        ...
        "animation": {
            ...
            "frames": END_FRAME,
            "fps": FPS,
            "motions": ["breathing body bob", "antenna drift", "two blinks"],
