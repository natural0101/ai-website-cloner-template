...
ASSET = "bottom_hand_result_v3"
SCENE_NAME = "BottomHandResultV3Scene"
WIDTH = 1000
HEIGHT = 820
...
def create_bottom_hand_blockout(target: dict, collection: bpy.types.Collection, clay_mat: bpy.types.Material, cuff_mat: bpy.types.Material) -> list[bpy.types.Object]:
    ...
    parts.append(
        st.create_ellipsoid(
            name="BHCV3_PalmCup",
            location=(-0.06, -0.58, -0.79),
            scale=(0.44, 0.19, 0.18),
            rotation=(0.0, math.radians(-12), math.radians(-3)),
            segments=56,
            rings=32,
            collection=collection,
            material=clay_mat,
    ...
    parts.append(
        st.create_ellipsoid(
            name="BHCV3_PalmHeel",
            location=(-0.35, -0.66, -0.94),
            scale=(0.28, 0.12, 0.12),
    ...
    parts.append(
        st.create_ellipsoid(
            name="BHCV3_FingerRootPad",
            location=(-0.05, -0.72, -0.91),
            scale=(0.42, 0.10, 0.095),
    ...
    parts.append(
        st.create_ellipsoid(
            name="BHCV3_ThumbWebPad",
            location=(0.35, -0.54, -0.58),
            scale=(0.21, 0.12, 0.13),
    ...
    # v3: separate, controlled smooth tubes. The sphere hides the finger roots in the final composition.
    finger_specs = [
        (
            "BHCV3_Index",
            [(0.23, -0.70, -0.74), (0.02, -0.82, -0.82), (-0.32, -0.79, -0.79), (-0.62, -0.62, -0.67)],
            [0.090, 0.104, 0.094, 0.066],
        ),
        (
            "BHCV3_Middle",
            [(0.12, -0.76, -0.89), (-0.12, -0.90, -1.02), (-0.39, -0.88, -1.00), (-0.58, -0.70, -0.90)],
            [0.090, 0.102, 0.088, 0.062],
        ),
        (
            "BHCV3_Ring",
            [(0.01, -0.79, -1.00), (-0.20, -0.92, -1.13), (-0.42, -0.86, -1.12), (-0.50, -0.68, -1.02)],
            [0.078, 0.088, 0.076, 0.054],
        ),
        (
            "BHCV3_Little",
            [(-0.10, -0.80, -1.08), (-0.25, -0.88, -1.17), (-0.40, -0.78, -1.15), (-0.44, -0.62, -1.06)],
            [0.060, 0.068, 0.058, 0.044],
        ),
    ]
    ...
    thumb_points = [(0.33, -0.53, -0.60), (0.51, -0.60, -0.42), (0.68, -0.53, -0.28)]
    thumb_radii = [0.112, 0.106, 0.078]
    parts.append(
        create_tapered_tube_mesh(
            name="BHCV3_Thumb",
            points=thumb_points,
    ...
    add_tip("BHCV3_Thumb", thumb_points[-1], thumb_radii[-1])

    wrist_points = [(1.48, -0.47, -0.52), (1.06, -0.48, -0.52), (0.60, -0.52, -0.60), (0.18, -0.59, -0.76)]
    wrist_radii = [0.188, 0.186, 0.150, 0.104]
    parts.append(
        create_tapered_tube_mesh(
            name="BHCV3_Wrist",
            points=wrist_points,
...
def main() -> dict:
    ...
    scene_graph = {
        "schema_version": "bottom-hand-result-v3",
        "asset": ASSET,
        "target_mode": "HYBRID_HERO",
        "stage": "controlled smooth-tube bottom hand from bottom_hand_target_v1",
        "source_target": str(TARGET),
        "triangle_budget": 90000,
        "semantic_objects": [
            {"name": "palm", "sources": ["BHCV3_PalmCup", "BHCV3_PalmHeel", "BHCV3_FingerRootPad", "BHCV3_ThumbWebPad"]},
            {"name": "fingers", "sources": ["BHCV3_Index", "BHCV3_Middle", "BHCV3_Ring", "BHCV3_Little"]},
            {"name": "thumb", "sources": ["BHCV3_Thumb"]},
            {"name": "wrist", "sources": ["BHCV3_Wrist"]},
            {"name": "cuff", "sources": ["BHCV3_Cuff"]},
        ],
        "expected_contacts": [
            {"a": "finger roots", "b": "BHCV3_FingerRootPad/BHCV3_PalmCup", "relation": "OVERLAPS", "minimum": "visible overlap before any union"},
            {"a": "BHCV3_Thumb", "b": "BHCV3_ThumbWebPad/BHCV3_PalmCup", "relation": "OVERLAPS", "minimum": "thumb is separate but rooted"},
            {"a": "BHCV3_Wrist", "b": "BHCV3_Cuff/BHCV3_PalmCup", "relation": "OVERLAPS", "minimum": "wrist reaches cuff and palm"},
        ],
        "do_not_claim": [
            "not final",
            "not accepted",
    ...
    clay_mat = material("BHCV3_MAT_WarmHand", (1.0, 0.61, 0.12, 1.0), 0.58)
    cuff_mat = material("BHCV3_MAT_SoftPinkCuff", (1.0, 0.78, 0.88, 1.0), 0.66)
    guide_mat = material("BHCV3_MAT_GuideSphere", (0.22, 0.66, 0.11, 0.48), 0.64, alpha=0.48)
    ...
    qa = {
        ...
        "observations": [
            "New version replaces lumpy metaballs with controlled smooth tapered tube meshes.",
            "Fingers are kept separate and readable; sphere occludes the roots in the final web composition.",
